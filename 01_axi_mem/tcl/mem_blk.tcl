...
################################################################
# This is a generated script based on design: mem_blk
#
...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net axi_bram_ctrl_0_bram_rsta_busy  [get_bd_pins axi_bram_ctrl_0_bram/rsta_busy] \
  [get_bd_ports rsta_busy]
  connect_bd_net -net s_axi_aclk_0_1  [get_bd_ports s_axi_aclk] \
  [get_bd_pins axi_bram_ctrl_0/s_axi_aclk]
  connect_bd_net -net s_axi_aresetn_0_1  [get_bd_ports s_axi_aresetn] \
